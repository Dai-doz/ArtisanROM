...
#
# SEC Floating Feature for Galaxy A12s (a12s) based on Floating Feature of beyond1lte

# Device Info
SEC_FLOATING_FEATURE_SETTINGS_CONFIG_BRAND_NAME=Galaxy A12s
SEC_FLOATING_FEATURE_SETTINGS_CONFIG_FCC_ID=A3LSMA127F
SEC_FLOATING_FEATURE_SETTINGS_CONFIG_ELECTRIC_RATED_VALUE="DC 5 V; 2 A"
SEC_FLOATING_FEATURE_SYSTEM_CONFIG_SIOP_POLICY_FILENAME=siop_a12s_exynos850
